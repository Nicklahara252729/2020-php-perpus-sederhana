...
if(isset($_POST['kd_mahasiswa'])){
	...
	$no_pinjam = $_POST['no_pinjam'];
		...
		$insertData = mysqli_query($host,"insert into pengembalian set no_pinjam='$no_pinjam',tgl_kembali='$tgl_kembali',kd_mahasiswa='$kd_mahasiswa',denda='$denda'");
		if($insertData){ ?>
			<script type="text/javascript">alert('Data berhasil disimpan'); window.location.href='pengembalian.php';</script>
		<?php }else{ ?>
		...
		<div class="row">
			<div class="offset-2 col-md-8 mt-5">
				<form method="post" target="_self"> 
				  ...
				  <div class="form-group">
				    <label for="no_pinjam">Nomor Pinjam</label>
